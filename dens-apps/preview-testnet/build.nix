  ...
  config = {
    perSystem = { pkgs, config, ... }: {
      packages = {
        ...
        ogmios-preview-testnet-image = pkgs.dockerTools.buildImage {
          name = "ogmios";
          tag = "latest";
          created = "now";
        ...
        dens-query-preview-testnet-image = pkgs.dockerTools.buildImage {
          name = "dens-query";
          tag = "latest";
          created = "now";
          ...
          runAsRoot = ''
            ...
            cp ${./dens-query-config.json} /etc/dens-query/config.json
          '';
        ...
        dens-pdns-preview-testnet-image = pkgs.dockerTools.buildImage {
          name = "dens-pdns";
          tag = "latest";
          created = "now";
        ...
        dens-pdns-backend-preview-testnet-image = pkgs.dockerTools.buildImage {
        ...
        dens-query-postgres-preview-testnet-image = pkgs.dockerTools.buildImage {
